...
def count_hfacs(filepath: Path | str = "data/processed/step3_hfacs_categories.csv") -> Tuple[Dict[str, int], int]:
    ...
    with p.open("r", encoding="utf-8") as f:
        ...
        if not cols:
            ...
            tokens = ["Error", "Violation", "Inadequate", "Personnel", "Situational", "Condition", "Organizational", "Resource"]
        ...
        for r in reader:
            ...
            for c in cols:
                ...
                try:
                    ...
                    val = 1 if str(v).strip().lower() in ("y", "yes", "true", "t") else 0
